...
class IR:
    ...
    def __init__(self):
        self.pinArray = [6] #codice più manutenibule, se voglio aggiungere IR basta aggiungere nell'array gli altri pin e andrà a creare tanti topic quanti sono gli IR - comportamento dinamico qualora voglia aggiungere altri IR
